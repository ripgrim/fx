...
<dialog id="lightbox" aria-labelledby="lightbox-title" aria-describedby="lightbox-help"><div class="lightbox-shell"><header><h2 id="lightbox-title">Comparison lightbox</h2><button id="lightbox-close" aria-label="Close comparison lightbox">Close · Esc</button></header><nav aria-label="Image zoom"><output id="zoom-value" aria-live="polite">100%</output><button id="zoom-native">100%</button><button id="zoom-fit">Fit / reset</button></nav><div class="lightbox-views"><figure><h2>Source</h2><div class="lightbox-viewport" tabindex="0" aria-label="Source capture, drag or use arrow keys to pan"><canvas id="lightbox-source"></canvas></div></figure><figure><h2>Paper</h2><div class="lightbox-viewport" tabindex="0" aria-label="Paper capture, drag or use arrow keys to pan"><canvas id="lightbox-paper"></canvas></div></figure><figure><h2>Difference</h2><div class="lightbox-viewport" tabindex="0" aria-label="Difference capture, drag or use arrow keys to pan"><canvas id="lightbox-diff"></canvas></div></figure></div><p id="lightbox-help" class="lightbox-note">Scroll or pinch to zoom · Drag to pan</p></div></dialog>
<script>
...
function openLightbox(id){if(!images||lightbox.open)return;lightbox_opener=$(id);prior_overflow=document.documentElement.style.overflow;document.documentElement.style.overflow='hidden';$('lightbox-title').textContent=(crop?'Selected region':'Full surface')+' comparison';lightbox.showModal();syncLightbox();fitLightbox();$('lightbox-close').focus()}
