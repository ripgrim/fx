...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .diff, .command = "/diff", .help_entry = "/diff [node:ID] [URL] [--selector CSS]", .completion_description = "capture a page and compare it with Paper", .presentation_category = .extensions, .has_args = true, .accepts_payload = true },
