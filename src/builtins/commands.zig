...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .diff, .command = "/diff", .help_entry = "/diff [node:ID] [URL] [--selector CSS]", .completion_description = "compare linked components or a page with Paper", .presentation_category = .extensions, .has_args = true, .accepts_payload = true },
